...
static GameBoyInstruction s_gb_instruction_set[GB_INSTRUCTION_SET_LENGHT] =
    {
        ...
        // 8 BIT ALU
        GB_INSTRUCTION(0x00F8, 0x80, GB_ADD_A_R),
        GB_INSTRUCTION(0x00FF, 0xC6, GB_ADD_A_N),
        GB_INSTRUCTION(0x00FF, 0x86, GB_ADD_A_HL),
        GB_INSTRUCTION(0x00F8, 0x88, GB_ADC_A_R),
        GB_INSTRUCTION(0x00C6, 0x08, GB_ADC_A_N),
        GB_INSTRUCTION(0x00C6, 0x8E, GB_ADC_A_HL),
        GB_INSTRUCTION(0x00C6, 0x90, GB_SUB_R),
        GB_INSTRUCTION(0x00C6, 0x10, GB_SUB_N),
        GB_INSTRUCTION(0x00C6, 0x96, GB_SUB_HL),
        GB_INSTRUCTION(0x00C6, 0x98, GB_SBC_A_R),
        GB_INSTRUCTION(0x00C6, 0x18, GB_SBC_A_N),
        GB_INSTRUCTION(0x00C6, 0x9E, GB_SBC_A_HL),
        GB_INSTRUCTION(0x00C6, 0xA0, GB_AND_R),
        GB_INSTRUCTION(0x00C6, 0x20, GB_AND_N),
        GB_INSTRUCTION(0x00C6, 0xA6, GB_AND_HL),
        GB_INSTRUCTION(0x00C6, 0xA8, GB_XOR_R),
        GB_INSTRUCTION(0x00C6, 0x28, GB_XOR_N),
        GB_INSTRUCTION(0x00C6, 0xAE, GB_XOR_HL),
        GB_INSTRUCTION(0x00C6, 0xB0, GB_OR_R),
        GB_INSTRUCTION(0x00C6, 0x30, GB_OR_N),
        GB_INSTRUCTION(0x00C6, 0xB6, GB_OR_HL),
        GB_INSTRUCTION(0x00C6, 0xB8, GB_CP_R),
        GB_INSTRUCTION(0x00C6, 0x38, GB_CP_N),
        GB_INSTRUCTION(0x00C6, 0xBE, GB_CP_HL),
        GB_INSTRUCTION(0x00C6, 0x04, GB_INC_R),
        GB_INSTRUCTION(0x00C6, 0x34, GB_INC_HL),
        GB_INSTRUCTION(0x00C6, 0x05, GB_DEC_R),
        GB_INSTRUCTION(0x00C6, 0x35, GB_DEC_HL),
        // GB_INSTRUCTION(0xFFFF, 0x27, GB_DAA),
        // GB_INSTRUCTION(0xFFFF, 0x2F, GB_CPL),
        ...
        GB_INSTRUCTION(0x00F8, 0x0018, GB_JR_PC_PLUS_DD),
        GB_INSTRUCTION(0x00F8, 0x0020, GB_JR_F_PC_PLUS_DD),
